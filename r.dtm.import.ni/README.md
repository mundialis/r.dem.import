...
*r.dtm.import.ni* downloads and imports [digital terrain model (DTM, in German DGM)](https://ni-lgln-opengeodata.hub.arcgis.com/apps/lgln-opengeodata::digitales-gel%C3%A4ndemodell-dgm1/about) for Niedersachsen (NI) and area of interest.  
