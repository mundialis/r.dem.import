...
| SH | | n.a. | | | | | [Geoportal](https://geodaten.schleswig-holstein.de/gaialight-sh/_apps/dladownload/) <br> [iDSM](https://geodaten.schleswig-holstein.de/gaialight-sh/_apps/dladownload/dl-bdom.html) |
