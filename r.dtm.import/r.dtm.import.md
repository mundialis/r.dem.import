...
*r.dtm.import* downloads and imports digital terrain models (DTM, in
German DGM) for specified federal state and area of interest.
...
In the federal state folders the addons searches for `xyz` files. If
local data does not overlap with aoi, data will be downloaded from Open
Data portals if federal state supports Open Data.
