...
| Brandenburg (BB) | r.idsm.import fs=BB | DSM-DTM | Not available | r.dtm.import fs=BB |
| Bremen (HB) | Not available | DSM-DTM | r.dsm.import fs=HB | r.dtm.import fs=HB |
| Hamburg (HH) | r.idsm.import fs=HH | DSM-DTM | Not available | r.dtm.import fs=HH |
| Hessen (HE) | Not available | DSM-DTM | r.dsm.import fs=HE | r.dtm.import fs=HE |
| Mecklenburg-Vorpommern (MV) | TODO | TODO | TODO | TODO |
| Niedersachsen (NI) | TODO | DSM-DTM | r.dsm.import fs=NI | r.dtm.import fs=NI |
| Nordrhein-Westfalen (NW) | r.idsm.import fs=NW | r.ndsm.import fs=NW | Not available | r.dtm.import fs=NI |
| Rheinland-Pfalz (RP) | TODO | TODO | Not available | TODO |
