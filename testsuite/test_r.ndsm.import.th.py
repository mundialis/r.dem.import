...
############################################################################
#
# MODULE:      r.ndsm.import test Thüringen
# AUTHOR(S):   Veronica Koess, Anika Weinmann
# PURPOSE:     Tests r.ndsm.import Thüringen
...
class TestRNdsmImportTH(RImportNdsmTestBase):
    """Test class for r.ndsm.import for TH"""
