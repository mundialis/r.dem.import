...
*r.dtm.import.he* downloads and imports [digital terrain model (DTM, in
German
DGM)](https://www.geoportal.hessen.de/mapbender/php/mod_showMetadata.php?languageCode=de&resource=layer&layout=tabs&id=36995)
for Hessen (HE) and area of interest.  
