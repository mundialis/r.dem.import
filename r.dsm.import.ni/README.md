...
*r.dsm.import.ni* downloads and imports [digital surface model (DSM, in
German
DOM)](https://ni-lgln-opengeodata.hub.arcgis.com/apps/lgln-opengeodata::digitales-oberfl%C3%A4chenmodell-dom1/about)
