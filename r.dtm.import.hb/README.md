...
*r.dtm.import.hb* downloads and imports [digital terrain model (DTM, in German DGM)](https://www.metaver.de/trefferanzeige?docuuid=2351ABA6-019D-4155-853F-76EEFC26CA52&q=dgm-bremen) for Bremen and Bremerhaven (HB) and area of interest.  
...
```sh
r.dtm.import.hb aoi=aoi output=dtm -r
```
