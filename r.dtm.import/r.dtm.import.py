...
# % multiple: yes
# % required: no
# % options: Berlin,BE,Baden-Württemberg,Brandenburg,BB,BW,Bayern,BY,Bremen,HB,Hamburg,HH,Hessen,HE,Sachsen,Mecklenburg-Vorpommern,MV,NI,Niedersachsen,Rheinland-Pfalz,RP,SH,Schleswig-Holstein,SN,Thüringen,TH,Nordrhein-Westfalen,NW
